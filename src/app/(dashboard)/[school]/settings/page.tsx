...
export default async function SettingsPage({ params }: Props) {
  ...
  if (!schoolData) redirect("/login")

  const [classCount, subjectCount, studentCount, staffCount] = await Promise.all([
  ...
  return (
    <div className="p-6 max-w-2xl">
      <div className="mb-6">
        ...
        <p className="text-gray-500 mt-1">School profile and configuration</p>
      </div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 mb-6">
        ...
        <dl className="space-y-3">
          {[
            ...
            { label: "School ID (Slug)", value: schoolData.slug },
